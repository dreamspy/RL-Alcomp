...
ADD ./data/CartPole-v1/GBDTA_100/CartPole_GBDTA_100_-f_eval-8_WWWWWWWWWWWunderModel.joblib.gz ./data/CartPole-v1/GBDTA_100/

ADD ./*.py ./
ADD ./agents/*.py ./agents/

CMD ["python", "trying_wundermodel.py"]
